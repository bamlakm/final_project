...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na /content/drive/MyDrive/final_project_starter_code/mechanisms/na.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/content/drive/MyDrive/final_project_starter_code/mechanisms/na.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "na.mod\n"
  "\n"
